...
typedef StyledTextAdvanceWidgetBuilderCallback = Widget Function(
...
///
/// Consider using the simpler [StyledTextAdvance] instead.
///
/// Example:
/// ```dart
...
///
class CustomStyledTextAdvance extends StatefulWidget {
  ...
  final StyledTextAdvanceWidgetBuilderCallback builder;
  ...
  @override
  _CustomStyledTextAdvanceState createState() =>
      _CustomStyledTextAdvanceState();
}

class _CustomStyledTextAdvanceState extends State<CustomStyledTextAdvance> {
  String? _text;
  TextSpan? _textSpans;
  _Node? _rootNode;
  ...
  @override
  void didUpdateWidget(CustomStyledTextAdvance oldWidget) {
  ...
  StyledTextAdvanceTagBase? _tag(String? tagName) {
        ...
        switch (e.state) {
          ...
          case XmlState.Open:
            ...
            if (e.value == 'br') {
              ...
              StyledTextAdvanceTagBase? tag = _tag(e.value);
